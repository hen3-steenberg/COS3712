...
export glm::vec3
getPosition(rapidobj::Result const& object, rapidobj::Index idx)
{
    return glm::vec3{
...
export glm::vec3
getNormal(rapidobj::Result const& object, rapidobj::Index idx)
{
    return glm::vec3{
...
export glm::vec2
getTexCoord(rapidobj::Result const& object, rapidobj::Index idx)
{
    return glm::vec2{
